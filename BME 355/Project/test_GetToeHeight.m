...
assert(GetToeHeight(model, 0, model.GetTilt(0)) == model.GetHeight(0), "Zero-time, horizontal");
assert(GetToeHeight(model, 1.2, model.GetTilt(1.2)) == model.GetHeight(1.2), "Final-time, horizontal");

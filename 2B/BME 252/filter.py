...
basePath = "C:/Users/User/Desktop/School/2B/BME 252/Project/Media/"
fileNames = ["Single Female.wav",
            #  "Single Male.wav",
            #  "Dual Male Female.wav",
            #  "Baby.wav",
            #  "Speech on Coffee Shop.wav",
            #  "Speech on Traffic.wav",
            #  "Speech on Loud Background.wav",
            #  "Speech on Kitchen.wav",
            #  "Nonspeech Instrumental.wav",
            #  "Nonspeech Microwave.wav",
            #  "Nonspeech Phone Ring.wav",
            #  "Nonspeech Traffic.wav",
            #  "Nonspeech Water.wav"
             ]
...
# Task 8 - Envelope extraction: detect envelopes using lowpass filter with 200Hz cutoff (better than 400 Hz)
...
def analyze (path, fileName):
    ...
    # play = sa.play_buffer(arr, 1, 2, samplingRate)
    # play.wait_done()
    write(f'filtered_{fileName}', samplingRate, output)

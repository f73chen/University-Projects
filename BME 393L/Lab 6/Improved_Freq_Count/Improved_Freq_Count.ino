...
void setup() {
  ...
  TCCR0B = _BV(CS02);/* Writes to Timer0 register to change it's clock rate this would sets bit CS02 and CS00 to 1 so timer clock = clkIO/1024 see "_BV Explained.pdf" on LEARN*/
}
...
//      scaledPeriod = period * 16;
//      frequency = 1 / scaledPeriod;
      frequency = 250 / float(millis() - startTime);
